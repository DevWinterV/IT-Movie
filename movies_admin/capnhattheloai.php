...
<?php
                ...
                $ID = $_GET['id'];
                $quey = "select * FROM `genres` WHERE theloai_id =  $ID ";
                ...
                <form action='xulycapnhattheloai.php?id= <?php echo"$ID"; ?>' method= 'post' name ="f_themKH">
                <table border="0" cellpadding="0" align="center">
                <tr >
                        <th id ="tieudebang" colspan="2">
                            <font face="Times New Roman" size="5" color="#FFFFFF" align="CENTER">CẬP NHẬT THỂ LOẠI</font>
                        </th>
                    </tr>
                ...
                <tr>
                    ...
                    <td>
                    <p id ="danhdau">
                        <input type="text" name = "txthoten" id ="txt" value= <?php echo"'".$row["ten_theloai"]."'"; ?>>
                       *</p>
                    </td>
                </tr>
            ?>
